\begin{figure}[ht]
  \caption[Compare the efficiency of the proposed method and the naive algorithm]{This plot shows the total runtime of the naive algorithm and the proposed method to find the unique columns. The tables were saved in a CSV format.} % TODO: better caption
