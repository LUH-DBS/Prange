\begin{figure}[ht]
  \caption[Compare the efficiency of the proposed method and the naive algorithm]{This plot shows the total runtime of the proposed method and the naive algorithm as they search for unique columns in tables of different sizes. The tables were saved in a CSV format.}
