\begin{figure}[ht]
  \caption[Compare the efficiency between CSV and parquet format]{This plot shows runtime of the proposed method and the naive algorithm as they search for unique columns in tables of different sizes. We compare the runtime reading the data from CSV files and reading it from parquet files.}
