\begin{figure}[ht]
  \caption[Compare the efficiency with tables saved as CSV and as parquet files]{This plot shows the total runtime of the proposed method and the naive algorithm as they search for unique columns in tables of different sizes. Additionally, the runtime when reading the data from CSV files and from parquet files are being compared.}
