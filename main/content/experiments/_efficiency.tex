...
% Section~\ref{subsec:correctness_conclusions} has shown that the number of unique columns predicted by the model correlates roughly with the number of actual unique columns in the table. % TODO: is the last sentence necessary?
