...
Importantly, even the worst performing model with an input size of \num{5} rows predicts that \SI{40}{\percent} of all columns are unique. This rate drops % TODO: write better?
