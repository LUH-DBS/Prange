...
During the training and testing of a machine learning model, its performance is measured with different metrics. The basis for these experiments is how well the prediction of the machine learning model matches the reality. Table~\ref{table:true-false-neg-pos} shows the different possibilities of matches and how they are called. % TODO: write better, different word for the second 'matches'
