...
One existing algorithm which uses this characteristic is GORDIAN\footfullcite{gordian}. It works by finding the largest column combinations that have duplicate values and from those compute the minimal column combinations which exclusively contain unique values.
